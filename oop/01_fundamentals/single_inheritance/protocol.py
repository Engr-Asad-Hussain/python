...
items = [Product("Mouse", 2, 250), Product("Keyboard", 3, 550)]
...
total = calculate_total([Product("Keyboard", 2, 800), Product("Mouse", 3, 250)])
print(total)

total = calculate_total([Inventory("Food", 25, 150), Inventory("Stones", 150, 250)])
print(total)
